...
const { getSummary, getAll, getOne, create, update, remove, uploadCSV, getHistorical, getMapData, exportData, getLocations, generateReport, exportReport, getNearbyCases } = require('../../controllers/dengueDataController');
